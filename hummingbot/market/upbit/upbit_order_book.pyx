...
_upbitob_logger = None


cdef class UpbitOrderBook(OrderBook):
    @classmethod
    def logger(cls) -> HummingbotLogger:
        global _upbitob_logger
        if _upbitob_logger is None:
            _upbitob_logger = logging.getLogger(__name__)
        return _upbitob_logger
    ...
    def trade_message_from_exchange(cls,
        ...
        content = {
            ...
            "trade_type": float(TradeType.BUY.value) if msg["ask_bid"] == "BID" else float(TradeType.SELL.value),
            "trade_id": msg["sequential_id"],
            "update_id": msg_ts,
